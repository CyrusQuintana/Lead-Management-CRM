module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('reports', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('interactions', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('reports', 'content', { transaction });
      ...
      await queryInterface.removeColumn('interactions', 'interaction_date', {
        transaction,
      });

      await queryInterface.removeColumn('interactions', 'userId', {
        transaction,
      });
